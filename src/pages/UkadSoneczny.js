...
const UkadSoneczny = () => {
  ...
  return (
    <div className="ukad-soneczny">
      <div className="nacinij-na-planet-container">
        <p className="nacinij-na-planet">
          Naciśnij na planetę, aby poznać więcej szczegółów.
        </p>
        <p className="nacinij-na-planet">&nbsp;</p>
        <p className="nacinij-na-planet">
          Przeciągnij dwoma palcami, aby przybliżyć.
        </p>
      </div>
      <div className="ukad-soneczny1">Układ słoneczny</div>
      <div className="maska-z-cieniem" />
      <div className="nacinij-na-planet-container">
        <p className="nacinij-na-planet">
          Naciśnij na planetę, aby poznać więcej szczegółów.
        </p>
